...
//  Ceyboard++
//
//  Created by Brennan Zimmer on 11/16/16.
...
class GoogleDriveViewController: UIViewController{
    ...
    private let kClientID = "158467426693-sbds9dtldo291igfpjo276e6e7s2ooru.apps.googleusercontent.com"
    ...
    func viewController(vc : UIViewController,
        ...
        dismiss(animated: true, completion: nil) //possibly change HERE
    }
